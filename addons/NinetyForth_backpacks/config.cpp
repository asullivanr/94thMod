...
class cfgVehicles {
	...
	class NinetyForth_BaseMiniRadio_Backpack : SWLB_clone_RTO_mini_backpack {
		scope = 0;
		displayName = "Clone trooper RTO mini pack";
	...
	// Backpacks playable Long range
	class NinetyForth_Backpack_MiniRadio : NinetyForth_BaseMiniRadio_Backpack {
		scope = 2;
		author = "Legion Studios";
		displayName = "[94th] Clone trooper RTO mini pack";
	};
	class NinetyForth_Backpack_MiniRadio_night : NinetyForth_BaseMiniRadio_Backpack {
		scope = 2;
		author = "Legion Studios";
		displayName = "[94th] Clone trooper RTO mini pack (Night)";
		hiddenSelectionsTextures[] =
		{
